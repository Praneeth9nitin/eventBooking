...
export type GetBookingSeatAggregateType<T extends BookingSeatAggregateArgs> = {
    [P in keyof T & keyof AggregateBookingSeat]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateBookingSeat[P]> : Prisma.GetScalarType<T[P], AggregateBookingSeat[P]>;
};
...
type GetBookingSeatGroupByPayload<T extends BookingSeatGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<BookingSeatGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof BookingSeatGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], BookingSeatGroupByOutputType[P]> : Prisma.GetScalarType<T[P], BookingSeatGroupByOutputType[P]>;
}>>;
export type BookingSeatWhereInput = {
    ...
    seatId?: Prisma.IntFilter<"BookingSeat"> | number;
...
export type BookingSeatWhereUniqueInput = Prisma.AtLeast<{
    seatId?: number;
    bookingId_seatId?: Prisma.BookingSeatBookingIdSeatIdCompoundUniqueInput;
    AND?: Prisma.BookingSeatWhereInput | Prisma.BookingSeatWhereInput[];
    OR?: Prisma.BookingSeatWhereInput[];
    NOT?: Prisma.BookingSeatWhereInput | Prisma.BookingSeatWhereInput[];
    bookingId?: Prisma.IntFilter<"BookingSeat"> | number;
...
export type BookingSeatScalarWhereWithAggregatesInput = {
    ...
    seatId?: Prisma.IntWithAggregatesFilter<"BookingSeat"> | number;
};
export type BookingSeatCreateInput = {
    booking: Prisma.BookingCreateNestedOneWithoutSeatsInput;
    seat: Prisma.SeatCreateNestedOneWithoutBookingSeatInput;
};
...
export type BookingSeatUpdateInput = {
    ...
    seat?: Prisma.SeatUpdateOneRequiredWithoutBookingSeatNestedInput;
};
...
export type BookingSeatCreateNestedOneWithoutSeatInput = {
    create?: Prisma.XOR<Prisma.BookingSeatCreateWithoutSeatInput, Prisma.BookingSeatUncheckedCreateWithoutSeatInput>;
    connectOrCreate?: Prisma.BookingSeatCreateOrConnectWithoutSeatInput;
    connect?: Prisma.BookingSeatWhereUniqueInput;
};
export type BookingSeatUncheckedCreateNestedOneWithoutSeatInput = {
    create?: Prisma.XOR<Prisma.BookingSeatCreateWithoutSeatInput, Prisma.BookingSeatUncheckedCreateWithoutSeatInput>;
    connectOrCreate?: Prisma.BookingSeatCreateOrConnectWithoutSeatInput;
    connect?: Prisma.BookingSeatWhereUniqueInput;
};
export type BookingSeatUpdateOneWithoutSeatNestedInput = {
    create?: Prisma.XOR<Prisma.BookingSeatCreateWithoutSeatInput, Prisma.BookingSeatUncheckedCreateWithoutSeatInput>;
    connectOrCreate?: Prisma.BookingSeatCreateOrConnectWithoutSeatInput;
    upsert?: Prisma.BookingSeatUpsertWithoutSeatInput;
    disconnect?: Prisma.BookingSeatWhereInput | boolean;
    delete?: Prisma.BookingSeatWhereInput | boolean;
    connect?: Prisma.BookingSeatWhereUniqueInput;
    update?: Prisma.XOR<Prisma.XOR<Prisma.BookingSeatUpdateToOneWithWhereWithoutSeatInput, Prisma.BookingSeatUpdateWithoutSeatInput>, Prisma.BookingSeatUncheckedUpdateWithoutSeatInput>;
};
export type BookingSeatUncheckedUpdateOneWithoutSeatNestedInput = {
    create?: Prisma.XOR<Prisma.BookingSeatCreateWithoutSeatInput, Prisma.BookingSeatUncheckedCreateWithoutSeatInput>;
    connectOrCreate?: Prisma.BookingSeatCreateOrConnectWithoutSeatInput;
    upsert?: Prisma.BookingSeatUpsertWithoutSeatInput;
    disconnect?: Prisma.BookingSeatWhereInput | boolean;
...
export type BookingSeatOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"bookingId" | "seatId", ExtArgs["result"]["bookingSeat"]>;
...
export type BookingSeatCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<BookingSeatFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BookingSeatDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['BookingSeat'];
        meta: {
            name: 'BookingSeat';
        };
    };
     ...
     * const bookingSeatWithBookingIdOnly = await prisma.bookingSeat.findMany({ select: { bookingId: true } })
     *
     */
     ...
     * })
     *
     * // Create many BookingSeats and only return the `bookingId`
     * const bookingSeatWithBookingIdOnly = await prisma.bookingSeat.createManyAndReturn({
     ...
     * })
     *
     * // Update zero or more BookingSeats and only return the `bookingId`
     * const bookingSeatWithBookingIdOnly = await prisma.bookingSeat.updateManyAndReturn({
     *   select: { bookingId: true },
     *   where: {
     *     // ... provide filter here
     *   },
     ...
     * })
    **/
    count<T extends BookingSeatCountArgs>(args?: Prisma.Subset<T, BookingSeatCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], BookingSeatCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends BookingSeatGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, BookingSeatGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBookingSeatGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface BookingSeatFieldRefs {
    ...
    readonly seatId: Prisma.FieldRef<"BookingSeat", 'Int'>;
}
/**
